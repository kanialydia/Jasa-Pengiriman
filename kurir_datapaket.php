						...
						<div class="content">
							<header class="align-center">
								...
								<div class="table-wrapper">
									...
									<?php
									require('koneksi.php');
									$data="SELECT * FROM paket WHERE status='Proses'";
									...
									if($hasil){
										...
										while($baris=mysqli_fetch_array($hasil, MYSQLI_ASSOC))
											echo '
											<tr>
												<td><a href="kurir_kirimpaket.php?id_paket=' . $baris['id_paket'] . '" class="button special fit small icon fa-send">Finish</a></td>
